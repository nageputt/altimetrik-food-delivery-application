...
public class FoodDeliveryController {
	...
	@RequestMapping(path = "/searchRestaurants" , produces = {"application/json"})
	@ResponseBody
	public RestaurantModel searchRestaurants(@RequestBody Restaurants restaurants) {
		RestaurantModel restaurantModel = new RestaurantModel();
			List<Restaurants> restaurantList = restaurantService.searchRestaurants(restaurants.getRestaurant_rating());
			restaurantModel.setRestaurants(restaurantList);
		return restaurantModel;
	}
	
	@RequestMapping(path = "/searchFood" , produces = {"application/json"})
	@ResponseBody
	public  List<FoodMenu>  searchFood(@RequestBody FoodMenu foodMenu) {
		return menuService.searchFod(foodMenu.getPrice()); 
	}
	...
	@ResponseBody
	public  boolean addToCart(@RequestBody CartProducts cartProduct) {
	...
	@RequestMapping(path= "/mycart", produces = {"application/json"})
	@ResponseBody
	...
	@ResponseBody
	public boolean placeOrder(@RequestBody UserAccount userAccount){
