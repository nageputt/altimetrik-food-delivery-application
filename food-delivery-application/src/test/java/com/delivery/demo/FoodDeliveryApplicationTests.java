...
class FoodDeliveryApplicationTests {
	...
	public void searchRestaurants() {
		when(restaurantRepository.searchRestaurants(3)).thenReturn(new ArrayList<Restaurants>());
		restaurantService.searchRestaurants(3);
	}
	
	@Test
	public void searchFod() {
		when(menuRespository.searchFod(3)).thenReturn(new ArrayList<FoodMenu>());
		menuService.searchFod(3);
	}
